...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_butter(
    ...
    KC_LSHIFT, KC_LCTRL, KC_LALT, KC_LGUI, KC_SPACE,     KC_ENTER, MO(1),   KC_LEFT, KC_DOWN,   KC_RIGHT
  ),
  [1] = LAYOUT_butter(
    KC_F1,     KC_F2,    KC_F3,   KC_F4,   KC_F9,        KC_F6,    KC_F7,   KC_F8,   KC_PGUP,   KC_F10,
    KC_MPRV,   KC_MPLY,  KC_MNXT, KC_MUTE, KC_VOLD,      KC_VOLU,  KC_TRNS, KC_HOME, KC_PGDOWN, KC_END
  )
};
